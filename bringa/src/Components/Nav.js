            ...
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="My listings">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseMylistings">
                        <li>
                            <a href="listings.html">En attente <span class="badge badge-pill badge-primary">6</span></a>
                        </li>
                        <li>
                            <a href="listings.html">Active <span class="badge badge-pill badge-success">6</span></a>
                        </li>
                        <li>
                            <a href="listings.html">Rejetée <span class="badge badge-pill badge-danger">6</span></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Invoice">
                    <a class="nav-link" href="reclamation.html" target="_blank">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="commandes Page">
                    <a class="nav-link" href="commandes.html">
                        <i class="fa fa-fw fa-shopping-basket"></i>
                        <span class="nav-link-text">commandes Page</span>
                    </a>
                </li>
